...
func WithSuspendCurrentQueueTime(suspendT time.Duration) Option {
	return func(options *consumerOptions) {
...
func WithConsumeTimestamp(from time.Time) Option {
	return func(opts *consumerOptions) {
		opts.ConsumeTimestamp = from.Format("20060102150405")
	}
}
